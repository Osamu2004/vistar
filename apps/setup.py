...
from apps.data_provider.base import DataProvider
from apps.builder import make_dataprovider
from apps.utils.init import init_modules,zero_last_gamma
...
def setup_data_provider(
    exp_config: dict,  is_distributed: bool = True
) -> DataProvider:
    ...
    data_provider_class = make_dataprovider(dp_config)
    print(data_provider_class,1111111111111111111111111111111)
    ...
    print(data_provider.train,1111111111111111111111111111111)
    return data_provider

def setup_run_config(exp_config: dict, run_config_cls: type[RunStepConfig]) -> RunStepConfig:
...
def init_logger(logger_type: str, **kwargs):
