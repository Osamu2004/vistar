...
def lka_seg_lkauperb1(dataset: str) -> CBFCDSeg:
    from model_test_compete.LKA.backbone import lka_b1
...
def lka_seg_lkauperb3(dataset: str) -> CBFCDSeg:
    from model_test_compete.LKA.backbone import lka_b3
    backbone = lka_b3()
